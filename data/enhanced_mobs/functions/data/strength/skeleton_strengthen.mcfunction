...
data merge entity @s {ActiveEffects:[{Id:12,Amplifier:0,Duration:2147483647,ShowParticles:1}],HandItems:[{id:"bow",Count:1,tag:{Tags:["strength_skeleton_bow"],Enchantments:[{id:"power",lvl:6},{id:"punch",lvl:1}]}}],Health:42f}
tag @s add strength